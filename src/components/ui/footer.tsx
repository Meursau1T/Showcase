...
import { Box, Flex, Text, Link, Grid, GridItem, Image } from '@chakra-ui/react'
...
export const Footer = async ({ locale }: Footer) => {
    ...
    return (
        ...
        >
            ...
            >
                {/* 第一列：公司信息 */}
                <Flex direction="column" minW={{ md: '250px' }}>
...
const footerContent = {
    en: {
        ...
        headquarters:
            'Address: Building M, Xiaqiao Industrial Park, Dongcheng District, Dongguan City, Guangdong Province',
